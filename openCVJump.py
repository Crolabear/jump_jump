...
# 	else:
# 		pX,pY = findPerson(pix1)
# 		topLeftX,topLeftY,botRightX,botRightY=findFigCenter(pix1,pX,pY)
#
# 		distance = calculatePixDistance([pX,pY],[topLeftX/2+botRightX/2,topLeftY/2+botRightY/2])
# 		timePress = distance
# 		jumpRecord.append([i,picName,pX,pY,topLeftX,topLeftY,botRightX,botRightY,distance])
# 		print (jumpRecord)
# 		time.sleep(5)
# 		# longPress(record[5])
